...
cout<<"13- Kivy"<<endl;
cout<<"14- PyGame"<<endl;
cout<<"15- PyAutoGUI"<<endl;
cout<<"16- Selenium-WhatsApp"<<endl;
cout<<"17- Aplicación gráfica WhatsApp-SPAM"<<endl;
cout<<"0-  Exit"<<endl;
cout<<"    "<<endl;
cout<<"    "<<endl;
...
if(x==15){
system("bash --rcfile /home/roy/e/pyautogui/bin/activate");
}

if(x==16){
system("bash --rcfile /home/roy/e/whatsapp-selenium/bin/activate");
}

if(x==17){
system("bash --rcfile /home/roy/e/whatsapp-selenium-tkinter/bin/activate");
}
